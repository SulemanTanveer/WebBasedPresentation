  ...
  // document.getElementById('adcode').value = divElement(); 
	...
	var $next=vars.container.find('#'+itemID);
				...
				if(settings.controlsKeyboard){
					...
					$(document).keyup(function(e){
						switch(e.keyCode){
							...
							case 37:
							pause();
							//console.log(vars.active.attr('id'));
							prev($slider,settings);
							//console.log(vars.next(nextID));
							break;
		...
		prev=function($slider,settings,$next){
			...
			setTimeout(function(){
				var params=[];
				params.settings=settings;params.animateActive=settings.animateActive;params.direction=settings.slidePrevDirection;
...
vars.next.css({zIndex:2,opacity:1});
if(settings.animateActive){
	vars.active.css({
		top:0,
		left:0
	}).animate({
		top:values.top,left:values.left,
		opacity:1
...
$.fn.wptslider.preparations={
  ...
  $.fn.MessageBox = function() {
  	var a= vars.active.attr('id');
  	a= a.replace("wpt-item","")
            return a;
        };
